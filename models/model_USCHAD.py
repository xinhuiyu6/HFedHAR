...
class CNN_tiny(nn.Module):
    def __init__(self, input_channel, num_classes):
        ...
        self.fc = nn.Linear(1152, num_classes)  # 1024
...
class ActivityLSTM(nn.Module):
    def __init__(self, input_dim, hidden_dim=128, output_dim=12, num_layers=1):
